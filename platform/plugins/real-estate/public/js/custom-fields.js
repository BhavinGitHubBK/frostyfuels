...
/*!***************************************************************************!*\
  !*** ./platform/plugins/real-estate/resources/assets/js/custom-fields.js ***!
  \***************************************************************************/
...
$(document).ready(function () {
  var JobCustomFields = /*#__PURE__*/function () {
    function JobCustomFields() {
      _classCallCheck(this, JobCustomFields);
      _defineProperty(this, "$jobCustomFieldsWrap", $('.job-custom-fields-wrap'));
      _defineProperty(this, "$customFieldList", $('#custom-field-list'));
      _defineProperty(this, "options", window.jobCustomFields);
    }
    _createClass(JobCustomFields, [{
      key: "init",
      value: function init() {
        var _this = this;
        this.actions();
      ...
      value: function actions() {
        var _this2 = this;
        this.$jobCustomFieldsWrap.on('click', '#add-new', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var id, data, index;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 10:
                $('#addNewCustomFieldModal').modal('toggle');
              case 11:
              case "end":
