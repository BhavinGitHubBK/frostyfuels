...
/*!****************************************************************************!*\
  !*** ./platform/plugins/real-estate/resources/assets/js/project-import.js ***!
  \****************************************************************************/
...
var ProjectImport = /*#__PURE__*/function () {
  function ProjectImport() {
    var _this = this;
    _classCallCheck(this, ProjectImport);
    _defineProperty(this, "isDownloading", false);
    _defineProperty(this, "$wrapper", $('.project-import'));
    this.$wrapper.on('submit', '#project-import-form', function (event) {
      _this.submit(event);
    }).on('click', '.download-template', function (event) {
      _this.download(event);
    });
  }
  _createClass(ProjectImport, [{
    key: "submit",
