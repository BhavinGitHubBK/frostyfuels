        ...
        <div class="container-fluid w90 padtop30" style="padding: 15px 0;">
            <div class="col-12">
                ...
                <p class="addresshouse">
                    <i class="fas fa-map-marker-alt"></i> {{  implode(', ', [$project->city->name, $project->state->name]) }}
            ...
            <div class="projecthome mb-2">
                @php
                    $propertiesForSale = app(\Botble\RealEstate\Repositories\Interfaces\PropertyInterface::class)
                        ...
                        ] + \Botble\RealEstate\Facades\RealEstateHelper::getPropertyDisplayQueryConditions(),
                            8,
