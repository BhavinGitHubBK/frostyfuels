            ...
            <div class="agent-details">
                ...
                <div>
                    ...
                    @if ($account->email && ! setting('real_estate_hide_agency_email', 0))
                        <p><strong class="d-inline-block">{{ __('Email') }}</strong>: <span dir="ltr">{{ $account->email }}</span></p>
                    @endif
                    @if ($account->phone && ! setting('real_estate_hide_agency_phone', 0))
                        <p><strong class="d-inline-block">{{ __('Phone') }}</strong>: <span dir="ltr">{{ $account->phone }}</span></p>
                    @endif
