...
<main class="detailproject bg-white">
    ...
    <div class="container-fluid w90 padtop20">
        ...
        <p class="addresshouse">
            <i class="fas fa-map-marker-alt"></i> {{ implode(', ', [$property->city->name, $property->state->name]) }}
        ...
        <?php
            $statusLabel = $property->status_html;
            if ($property->type == 'bid') {
                $statusLabel = '<span class="label-success status-label">Biding</span>';
            }
        ?>
        <p class="pricehouse"> {{ $property->price_html }} {!! $statusLabel !!}</p>
        <div class="row">
            <div class="col-md-8">
                <div class="row pt-3">
                    <div class="col-sm-12">
                        ...
                        <div class="row item">
                            <div class="col-md-4 col-sm-5 pr-sm-0">
                                <div class="img h-100 bg-light">
                                    <a href="{{ $project->url }}">
                                        <img class="thumb lazy" data-src="{{ RvMedia::getImageUrl($project->image, null, false, RvMedia::getDefaultImage()) }}" src="{{ RvMedia::getImageUrl($project->image, null, false, RvMedia::getDefaultImage()) }}" alt="{{ $project->name }}">
                                    </a>
                                </div>
                            </div>
            ...
            <div class="col-md-4">
                ...
                @if ($property->type == 'bid')
                <div class="boxright p-3">
                    {!! Theme::partial('biding-place-form', ['type' => 'property', 'data' => $property]) !!}
                </div>
                @endif
                <div class="boxright p-3">
